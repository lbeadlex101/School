...
// NOTE: Does not meet program criteria for assignment. 
//------------------------------------------------------------------------------
#include <iostream>
#include <fstream>
#include <string>
...
double calculateCost(City cities[], int size, double &lowestCost);
//------------------------------------------------------------------------------
// Main driver:
int main()
{
    ...
    cout << endl << "Time Elapsed: "<< timeRan << endl;
...
{
    double cost = 0;
    double lowestCost = 100000; // Arbitrary low cost
    
    if(k == size)
    {
        cost = calculateCost(list, size, lowestCost);
...
double calculateCost(City cities[], int size, double &lowestCost)
{
    ...
    for (int i = 0; i < size; i++)
    {
        totalCost += calculateDistance(cities[i], cities[i+1]);
    }
